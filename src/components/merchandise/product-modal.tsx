        ...
        <DialogContent showCloseButton={true} className="sm:max-w-[560px] pt-12 pb-8 bg-white rounded-lg">
          ...
          <div className="flex justify-end">
            <Button
              ...
              onClick={() => {
                const formUrl = new URL("https://docs.google.com/forms/d/e/YOUR_FORM_ID/viewform"); // fields depend on form
                formUrl.searchParams.append("entry.FIELD_ID_1", product.title); 
                formUrl.searchParams.append("entry.FIELD_ID_2", `PHP ${product.price.toFixed(2)}`);
