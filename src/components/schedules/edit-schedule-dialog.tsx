    ...
    >
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Edit an existing game schedule. Click Submit when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-8 py-4">
          <div className="grid w-full grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setScheduleInputs((s) => ({ ...s, startDate: e.target.value }))
                }
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setScheduleInputs((s) => ({ ...s, endDate: e.target.value }))
                }
              />
            </div>
          </div>
          ...
          <div className="grid w-full grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setScheduleInputs((s) => ({ ...s, startTime: e.target.value }))
                }
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setScheduleInputs((s) => ({ ...s, endTime: e.target.value }))
                }
              />
            </div>
          </div>
          ...
          <div className="w-full">
            <Select
              value={sports.length > 0 ? selectedSport.toString() : ""}
              onValueChange={(value: string) => setSelectedSport(Number(value))}
          ...
          <div className="flex w-full items-center justify-between gap-4">
            <div className="flex w-full flex-col gap-1">
              ...
              <Select
                value={
                  sportTeams.length > 0 ? scheduleInputs.teamAId.toString() : ""
                }
                onValueChange={(value: string) =>
                  setScheduleInputs((s) => ({ ...s, teamAId: Number(value) }))
                }
              ...
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    {sportTeams.map((team) => (
                      <SelectItem key={team.id} value={team.teamId.toString()}>
                        {team.team.teamName}
                      </SelectItem>
                    ))}
                  </SelectGroup>
            ...
            <div className="flex w-full flex-col gap-1">
              ...
              <Select
                value={
                  sportTeams.length > 0 ? scheduleInputs.teamBId.toString() : ""
                }
                onValueChange={(value: string) =>
                  setScheduleInputs((s) => ({ ...s, teamBId: Number(value) }))
                }
                disabled={sportTeams.length <= 0 || fetchingTeams}
              >
                <SelectTrigger>
          ...
          <div className="flex w-full flex-col gap-1">
            ...
            <Input
              ...
              onChange={(e) =>
                setScheduleInputs((s) => ({ ...s, location: e.target.value }))
              }
            />
          </div>
        </div>
